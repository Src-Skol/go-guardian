	...
	*/
	...
	var E = {
		...
		enqueueUpdate: function t(e) {
			v(), g.isBatchingUpdates ? (p.push(e), null == e._updateBatchNumber && (e._updateBatchNumber = f + 1)) : g.batchedUpdates(t, e)
		},
		...
		injection: {
			...
			injectBatchingStrategy: function(t) {
				t || r("127"), "function" != typeof t.batchedUpdates && r("128"), "boolean" != typeof t.isBatchingUpdates && r("129"), g = t
			}
		},
		asap: function(t, e) {
			l(g.isBatchingUpdates, "ReactUpdates.asap: Can't enqueue an asap callback in a context whereupdates are not being batched."), h.enqueue(t, e), d = !0
		}
	};
	t.exports = E
}, function(t, e, n) {
	...
	(function(t, r) {
		...
		(function() {
			var i, a = 200,
				...
				de = "(?:" + fe + "|" + se + ")",
				ge = "(?:" + re + "|" + ue + ")" + "?",
				ve = "[\\ufe0e\\ufe0f]?" + ge + ("(?:\\u200d(?:" + [ce, le, pe].join("|") + ")[\\ufe0e\\ufe0f]?" + ge + ")*"),
				me = "(?:" + [ie, le, pe].join("|") + ")" + ve,
				ye = "(?:" + [ce + re + "?", re, le, pe, ee].join("|") + ")",
				_e = RegExp("['’]", "g"),
				be = RegExp(re, "g"),
				Ae = RegExp(ue + "(?=" + ue + ")|" + ye + ve, "g"),
				...
				ke = -1,
				Te = {};
			Te[lt] = Te[pt] = Te[ft] = Te[ht] = Te[dt] = Te[gt] = Te[vt] = Te[mt] = Te[yt] = !0, Te[V] = Te[W] = Te[ut] = Te[q] = Te[ct] = Te[z] = Te[K] = Te[$] = Te[G] = Te[Q] = Te[Z] = Te[et] = Te[nt] = Te[rt] = Te[at] = !1;
			var Se = {};
			Se[V] = Se[W] = Se[ut] = Se[ct] = Se[q] = Se[z] = Se[lt] = Se[pt] = Se[ft] = Se[ht] = Se[dt] = Se[G] = Se[Q] = Se[Z] = Se[et] = Se[nt] = Se[rt] = Se[ot] = Se[gt] = Se[vt] = Se[mt] = Se[yt] = !0, Se[K] = Se[$] = Se[at] = !1;
			var Pe = {
					"\\": "\\",
					"'": "'",
					"\n": "n",
			...
			var Dn = function t(e) {
				...
				function Ur(t, e, n, r, o, a) {
					...
					if (p) {
						...
						if (g == Z || g == V || v && !o) {
							if (s = c || v ? {} : Ki(t), !u) return c ? function(t, e) {
								return si(t, qi(t), e)
							}(t, function(t, e) {
				...
				}, vr.prototype = yr.prototype, vr.prototype.constructor = vr, _r.prototype = mr(yr.prototype), _r.prototype.constructor = _r, br.prototype = mr(yr.prototype), br.prototype.constructor = br, Ar.prototype.clear = function() {
								...
								if (l) jr(t, n, l);
									...
									if (f) {
										var h = _s(c),
											d = !h && Cs(c),
											g = !h && !d && Us(c);
										p = c, h || d || g ? _s(u) ? p = u : Es(u) ? p = ai(u) : d ? (f = !1, p = ti(c, !0)) : g ? (f = !1, p = ni(c, !0)) : p = [] : Rs(c) || ys(c) ? (p = u, ys(u) ? p = Ys(u) : (!Ps(u) || r && ks(u)) && (p = Ki(c))) : f = !1
									}
				...
				function Do(t, e, n, r) {
					...
					for (var o = 0, a = null == t ? 0 : t.length, s = e != e, u = null === e, c = Ds(e), l = e === i; o < a;) {
						var p = Wn((o + a) / 2),
							...
							v = Ds(f);
						if (s) var m = r || g;
						else m = l ? g && (r || h) : u ? g && h && (r || !d) : c ? g && h && !d && (r || !v) : !d && !v && (r ? f <= e : f < e);
						m ? o = p + 1 : a = p
					}
					return Xn(a, U)
				}
				...
				function mi(t, e, n, o, a, s, u, c, l, p) {
					...
					return function m() {
						...
						if (o && (b = oi(b, o, a, g)), s && (b = ii(b, s, u, g)), y -= C, g && y < p) {
							var w = On(b, E);
						...
						return y = b.length, c ? b = function(t, e) {
							...
							return t
						}(b, c) : v && y > 1 && b.reverse(), f && l < y && (b.length = l), this && this !== Ne && this instanceof m && (k = _ || di(k)), k.apply(x, b)
					}
				}
				...
				function Si(t, e, n, o, a, s, c, l) {
					...
					if (v && function(t, e) {
						...
						}(k, v), t = k[0], e = k[1], n = k[2], o = k[3], a = k[4], !(l = k[9] = k[9] === i ? f ? 0 : t.length : $n(k[9] - h, 0)) && e & (b | A) && (e &= ~(b | A)), e && e != m) T = e == b || e == A ? function(t, e, n) {
						var o = di(t);
						return function a() {
				...
				function Gi(t, e, n) {
					if (!Ps(n)) return !1;
					var r = typeof e;
					return !!("number" == r ? As(n) && Xi(e, n.length) : "string" == r && e in n) && gs(n[e], t)
				}
				...
				function Vu(t) {
					return Qi(t) ? gn(fa(t)) : function(t) {
						return function(e) {
							return Zr(e, t)
						}
					}(t)
				...
				return vr.after = function(t, e) {
				...
				}, vr.ary = ns, vr.assign = $s, vr.assignIn = Xs, vr.assignInWith = Gs, vr.assignWith = Qs, vr.at = Js, vr.before = rs, vr.bind = os, vr.bindAll = Su, vr.bindKey = is, vr.castArray = function() {
					if (!arguments.length) return [];
					var t = arguments[0];
					return _s(t) ? t : [t]
				}, vr.chain = Va, vr.chunk = function(t, e, n) {
				...
				}, vr.constant = Pu, vr.countBy = qa, vr.create = function(t, e) {
					var n = mr(t);
					...
					return o.placeholder = t.placeholder, o
				}, vr.debounce = as, vr.defaults = Zs, vr.defaultsDeep = tu, vr.defer = ss, vr.delay = us, vr.difference = ga, vr.differenceBy = va, vr.differenceWith = ma, vr.drop = function(t, e, n) {
					var r = null == t ? 0 : t.length;
				...
				}, vr.groupBy = Xa, vr.initial = function(t) {
					return null != t && t.length ? No(t, 0, -1) : []
				}, vr.intersection = Ea, vr.intersectionBy = Ca, vr.intersectionWith = wa, vr.invert = ru, vr.invertBy = ou, vr.invokeMap = Ga, vr.iteratee = Ru, vr.keyBy = Qa, vr.keys = au, vr.keysIn = su, vr.map = Ja, vr.mapKeys = function(t, e) {
					var n = {};
					...
					return yo(t, Ur(e, f))
				}, vr.memoize = cs, vr.merge = uu, vr.mergeWith = cu, vr.method = Nu, vr.methodOf = Mu, vr.mixin = Bu, vr.negate = ls, vr.nthArg = function(t) {
				...
				}, vr.over = Uu, vr.overArgs = ps, vr.overEvery = Fu, vr.overSome = Lu, vr.partial = fs, vr.partialRight = hs, vr.partition = Za, vr.pick = pu, vr.pickBy = fu, vr.property = Vu, vr.propertyOf = function(t) {
					return function(e) {
						return null == t ? i : Zr(t, e)
					}
				}, vr.pull = ka, vr.pullAll = Ta, vr.pullAllBy = function(t, e, n) {
					return t && t.length && e && e.length ? Co(t, e, Fi(n, 2)) : t
				}, vr.pullAllWith = function(t, e, n) {
					return t && t.length && e && e.length ? Co(t, e, i, n) : t
				}, vr.pullAt = Sa, vr.range = Wu, vr.rangeRight = Hu, vr.rearg = ds, vr.reject = function(t, e) {
				...
				}, vr.reverse = Pa, vr.sampleSize = function(t, e, n) {
				...
				}, vr.thru = Wa, vr.toArray = Vs, vr.toPairs = hu, vr.toPairsIn = du, vr.toPath = function(t) {
					return _s(t) ? nn(t, fa) : Ds(t) ? [t] : ai(pa(Ks(t)))
				}, vr.toPlainObject = Ys, vr.transform = function(t, e, n) {
					var r = _s(t),
						o = r || Cs(t) || Us(t);
					if (e = Fi(e, 4), null == n) {
					...
					return ns(t, 1)
				}, vr.union = ja, vr.unionBy = Oa, vr.unionWith = Ia, vr.uniq = function(t) {
				...
				}, vr.unzip = Ra, vr.unzipWith = Na, vr.update = function(t, e, n) {
				...
				}, vr.without = Ma, vr.words = ku, vr.wrap = function(t, e) {
					return fs(Xo(e), t)
				}, vr.xor = Ba, vr.xorBy = Da, vr.xorWith = Ua, vr.zip = Fa, vr.zipObject = function(t, e) {
					return Ko(t || [], e || [], Or)
				}, vr.zipObjectDeep = function(t, e) {
					return Ko(t || [], e || [], jo)
				}, vr.zipWith = La, vr.entries = hu, vr.entriesIn = du, vr.extend = Xs, vr.extendWith = Gs, Bu(vr, vr), vr.add = Yu, vr.attempt = Tu, vr.camelCase = vu, vr.capitalize = mu, vr.ceil = Ku, vr.clamp = function(t, e, n) {
				...
				}, vr.deburr = yu, vr.defaultTo = function(t, e) {
					return null == t || t != t ? e : t
				}, vr.divide = $u, vr.endsWith = function(t, e, n) {
					t = Ks(t), e = Lo(e);
					var r = t.length,
				...
				}, vr.find = za, vr.findIndex = ya, vr.findKey = function(t, e) {
					return cn(t, Fi(e, 3), Gr)
				}, vr.findLast = Ya, vr.findLastIndex = _a, vr.findLastKey = function(t, e) {
					return cn(t, Fi(e, 3), Qr)
				}, vr.floor = Xu, vr.forEach = Ka, vr.forEachRight = $a, vr.forIn = function(t, e) {
				...
				}, vr.get = eu, vr.gt = vs, vr.gte = ms, vr.has = function(t, e) {
					return null != t && Yi(t, e, ro)
				}, vr.hasIn = nu, vr.head = Aa, vr.identity = Iu, vr.includes = function(t, e, n, r) {
					t = As(t) ? t : gu(t), n = n && !r ? Hs(n) : 0;
					var o = t.length;
				...
				}, vr.invoke = iu, vr.isArguments = ys, vr.isArray = _s, vr.isArrayBuffer = bs, vr.isArrayLike = As, vr.isArrayLikeObject = Es, vr.isBoolean = function(t) {
					return !0 === t || !1 === t || js(t) && eo(t) == q
				}, vr.isBuffer = Cs, vr.isDate = ws, vr.isElement = function(t) {
				...
				}, vr.isFunction = ks, vr.isInteger = Ts, vr.isLength = Ss, vr.isMap = Os, vr.isMatch = function(t, e) {
					...
					return null === t
				}, vr.isNumber = Is, vr.isObject = Ps, vr.isObjectLike = js, vr.isPlainObject = Rs, vr.isRegExp = Ns, vr.isSafeInteger = function(t) {
					return Ts(t) && t >= -N && t <= N
				}, vr.isSet = Ms, vr.isString = Bs, vr.isSymbol = Ds, vr.isTypedArray = Us, vr.isUndefined = function(t) {
					return t === i
				...
				}, vr.kebabCase = _u, vr.last = xa, vr.lastIndexOf = function(t, e, n) {
					var r = null == t ? 0 : t.length;
					if (!r) return -1;
					var o = r;
				...
				}, vr.lowerCase = bu, vr.lowerFirst = Au, vr.lt = Fs, vr.lte = Ls, vr.max = function(t) {
					...
					return t && t.length ? zr(t, Fi(e, 2), go) : i
				}, vr.stubArray = qu, vr.stubFalse = zu, vr.stubObject = function() {
					return {}
				}, vr.stubString = function() {
					return ""
				}, vr.stubTrue = function() {
					return !0
				}, vr.multiply = Qu, vr.nth = function(t, e) {
					return t && t.length ? bo(t, Hs(e)) : i
				}, vr.noConflict = function() {
					return Ne._ === this && (Ne._ = ve), this
				}, vr.noop = Du, vr.now = es, vr.pad = function(t, e, n) {
					t = Ks(t);
					var r = (e = Hs(e)) ? Nn(t) : 0;
					if (!e || r >= e) return t;
					var o = (e - r) / 2;
				...
				}, vr.snakeCase = Eu, vr.some = function(t, e, n) {
					var r = _s(t) ? sn : Mo;
					return n && Gi(t, e, n) && (e = i), r(t, Fi(e, 3))
					...
					return -1
				}, vr.startCase = Cu, vr.startsWith = function(t, e, n) {
					...
					var g = e.variable;
					g || (f = "with (obj) {\n" + f + "\n}\n"), f = (a ? f.replace(_t, "") : f).replace(bt, "$1").replace(At, "$1;"), f = "function(" + (g || "obj") + ") {\n" + (g ? "" : "obj || (obj = {});\n") + "var __t, __p = ''" + (o ? ", __e = _.escape" : "") + (a ? ", __j = Array.prototype.join;\nfunction print() { __p += __j.call(arguments, '') }\n" : ";\n") + f + "return __p\n}";
					var v = Tu(function() {
					...
					return o
				}, vr.toFinite = Ws, vr.toInteger = Hs, vr.toLength = qs, vr.toLower = function(t) {
					...
					var e = ++fe;
					return Ks(t) + e
				}, vr.upperCase = wu, vr.upperFirst = xu, vr.each = Ka, vr.eachRight = $a, vr.first = Aa, Bu(vr, (Gu = {}, Gr(vr, function(t, e) {
					pe.call(vr.prototype, e) || (Gu[e] = t)
				}), Gu), {
					chain: !1
				}), vr.VERSION = "4.17.4", Ge(["bind", "bindKey", "curry", "curryRight", "partial", "partialRight"], function(t) {
					vr[t].placeholder = vr
					...
					o && (vr.prototype[e] = function() {
						...
						return d && g ? t.apply(this, s) : (v = this.thru(p), d ? r ? v.value()[0] : v.value() : v)
					})
					...
					return d
				}, vr.prototype.at = Ha, vr.prototype.chain = function() {
					return Va(this)
				...
				}, vr.prototype.first = vr.prototype.head, Fe && (vr.prototype[Fe] = function() {
					return this
				}), vr
			}();
			Ne._ = Dn, (o = function() {
	...
	var v = function(t) {
		return null == t ? void 0 === t ? d : h : g && g in Object(t) ? l(t) : f(t)
	};
	var m = function(t, e) {
		return function(n) {
			return t(e(n))
	...
	l.createElement = function(t, e, n) {
		...
		if (null != e)
			for (a in u(e) && (d = e.ref, g = o.current), c(e) && (h = "" + e.key), t.type && t.type.defaultProps && (p = t.type.defaultProps), e) i.call(e, a) && !s.hasOwnProperty(a) && (void 0 === e[a] && void 0 !== p ? f[a] = p[a] : f[a] = e[a]);
			...
			return function t(e, n, r) {
					...
					e.exports = function(e, n) {
						var r, o, i = e._getDomain,
							...
							l = u.isNode && (!!Object({
								...
								beaconFullpagePredictor: "https://staging-beacon-fullpage-predictor.goguardian.com",
								...
								scenesBlockPageUrl: "https://staging-student.goguardian.com/teacher/blocked.html",
				...
				19: [function(t, e, n) {
					...
					e.exports = function(e, n, r, o, i) {
						...
						u.inherits(h, n), h.prototype._init = function() {}, h.prototype._promiseFulfilled = function(t, n) {
							...
							g >= i && (null !== a ? this._filter(r, a) : this._resolve(r))
				...
				23: [function(t, n, r) {
					...
					n.exports = function() {
						...
						var f = function() {},
							...
							g = t("./thenables.js")(x, f),
							v = t("./promise_array.js")(x, f, g, a),
						...
						return x.prototype.toString = function() {
							...
							this._clearCallbackDataAtIndex(t), "function" == typeof r ? n ? this._settlePromiseFromHandler(r, a, i, e) : r.call(a, i, e) : a instanceof v ? a._isResolved() || (this._isFulfilled() ? a._promiseFulfilled(i, e) : a._promiseRejected(i, e)) : n && (this._isFulfilled() ? e._fulfill(i) : e._reject(i, o)), t >= 4 && 4 == (31 & t) && c.invokeLater(this._setLength, this, 0)
						...
						}, s.notEnumerableProp(x, "_makeSelfResolutionError", o), t("./progress.js")(x, v), t("./method.js")(x, f, g, a), t("./bind.js")(x, f, g), t("./finally.js")(x, d, g), t("./direct_resolve.js")(x), t("./synchronous_inspection.js")(x), t("./join.js")(x, v, g, f), x.version = "2.11.0", x.Promise = x, t("./map.js")(x, v, a, g, f), t("./cancel.js")(x), t("./using.js")(x, a, g, _), t("./generators.js")(x, a, f, g), t("./nodeify.js")(x), t("./call_get.js")(x), t("./props.js")(x, v, g, a), t("./race.js")(x, f, g, a), t("./reduce.js")(x, v, a, g, f), t("./settle.js")(x, v), t("./some.js")(x, v, a), t("./promisify.js")(x, f), t("./any.js")(x), t("./each.js")(x, f), t("./timers.js")(x, f), t("./filter.js")(x, f), s.toFastProperties(x), s.toFastProperties(x.prototype), k({
							a: 1
						}), k({
							b: 2
						}), k({
				...
				26: [function(t, e, n) {
					...
					e.exports = function(e, n) {
						...
						function v(t, e, n, r) {
							for (var i = o.inheritedDataKeys(t), a = [], s = 0; s < i.length; ++s) {
								var u = i[s],
									l = t[u],
									p = r === f || f(u, l, t);
								"function" != typeof l || d(l) || g(t, u, e) || !r(u, l, t, p) || a.push(u, l)
							}
							return function(t, e, n) {
						...
						function _(t, e, n, i) {
							for (var a = new RegExp(m(e) + "$"), s = v(t, e, a, n), u = 0, c = s.length; u < c; u += 2) {
								var l = s[u],
									p = s[u + 1],
									f = l + e;
					...
					e.exports = function(e, n, r, o, i) {
						...
						u.inherits(p, n), p.prototype._init = function() {}, p.prototype._resolveEmptyArray = function() {
							...
							if (i = f[n], 0 === n && this._zerothIsAccum ? (this._accum = t, this._gotAccum = p = !0, f[n] = 0 === i ? 1 : 2) : -1 === n ? (this._accum = t, this._gotAccum = p = !0) : 0 === i ? f[n] = 1 : (f[n] = 2, this._accum = t), p) {
								for (var h, d = this._callback, g = this._promise._boundValue(), v = this._reducingIndex; v < a; ++v)
									if (2 !== (i = f[v])) {
										if (1 !== i) return;
										if (t = r[v], this._promise._pushContext(), u ? (s.push(t), h = c(d).call(g, t, v, a)) : h = c(d).call(g, this._accum, t, v, a), this._promise._popContext(), h === l) return this._reject(h.e);
										var m = o(h, this._promise);
										if (m instanceof e) {
											if ((m = m._target())._isPending()) return f[v] = 4, m._proxyPromiseArray(this, v);
	...
	function y(t, e) {
		...
		if (e.singleton) {
			var a = c++;
			n = u || (u = v(e)), r = A.bind(null, n, a, !1), o = A.bind(null, n, a, !0)
	...
	var v = function() {
			function t(e, n, r) {
				! function(t, e) {
					if (!(t instanceof e)) throw new TypeError("Cannot call a class as a function")
				}(this, t), this.store = e, this.parentSub = n, this.onStateChange = r, this.unsubscribe = null, this.listeners = g
			}
				...
				a = function(n) {
					...
					return function(t, e) {
						...
						if (A) {
							...
							this.subscription = new v(this.store, t, this.onStateChange.bind(this)), this.notifyNestedSubs = this.subscription.notifyNestedSubs.bind(this.subscription)
						}
	...
	function M(t, e, n, r, o) {
		...
		function d(o, u) {
			var d, g, v = !a(u, l),
				m = !i(o, c);
			return c = o, l = u, v && m ? (p = t(c, l), e.dependsOnOwnProps && (f = e(r, l)), h = n(p, f, l)) : v ? (t.dependsOnOwnProps && (p = t(c, l)), e.dependsOnOwnProps && (f = e(r, l)), h = n(p, f, l)) : m ? (d = t(c, l), g = !s(d, p), p = d, g && (h = n(p, f, l)), h) : h
		}
		return function(o, i) {
	...
	function P(t, e, n, r) {
		...
		o.perform(S, null, t, e, o, n, r), v.ReactReconcileTransaction.release(o)
	}
	...
	var B = {
		...
		_updateRootComponent: function(t, e, n, r, o) {
			return B.scrollMonitor(r, function() {
				g.enqueueElementInternal(t, e, n), o && g.enqueueCallbackInternal(t, o)
			}), t
		},
		_renderNewRootComponent: function(t, e, n, o) {
			I(e) || r("37"), s.ensureScrollValueMonitoring();
			var i = y(t, !1);
			v.batchedUpdates(P, i, e, n, o);
		...
		_renderSubtreeIntoContainer: function(t, e, n, o) {
			g.validateCallback(o, "ReactDOM.render"), a.isValidElement(e) || r("39", "string" == typeof e ? " Instead of passing a string like 'div', pass React.createElement('div') or <div />." : "function" == typeof e ? " Instead of passing a class like Foo, pass React.createElement(Foo) or <Foo />." : null != e && void 0 !== e.props ? " This may be caused by unintentionally loading two independent copies of React." : "");
			...
			var d, v = T(n),
				y = v && !(!(d = v).getAttribute || !d.getAttribute(A)),
				_ = O(n),
				E = y && !c && !_,
	...
	t.exports = function(t, e, n) {
		return null == t ? 0 : function t(e, n, l, p) {
			...
			var d = 0,
				g = "" === n ? s : n + u;
			if (Array.isArray(e))
				for (var v = 0; v < e.length; v++) d += t(f = e[v], g + c(f, v), l, p);
			else {
				var m = i(e);
				if (m) {
					var y, _ = m.call(e);
					if (m !== e.entries)
						for (var b = 0; !(y = _.next()).done;) d += t(f = y.value, g + c(f, b++), l, p);
					else
						for (; !(y = _.next()).done;) {
							var A = y.value;
							A && (d += t(f = A[1], g + a.escape(A[0]) + u + c(f, 0), l, p))
						}
				} else if ("object" === h) {
					var E = String(e);
	...
	t.exports = function(t, e) {
		var n = i(t),
			...
			g = d.length;
		for (var v in t) !e && !c.call(t, v) || h && ("length" == v || p && ("offset" == v || "parent" == v) || f && ("buffer" == v || "byteLength" == v || "byteOffset" == v) || s(v, g)) || d.push(v);
		return d
	}
}, function(t, e, n) {
	var r = n(158),
	...
	*/
	...
	var _ = {
		...
		extractEvents: function(t, e, n, r) {
			...
			switch (t) {
				case "topFocus":
					(c(o) || "true" === o.contentEditable) && (h = o, d = e, g = null);
					break;
				case "topBlur":
	...
	var b = 1,
		A = {
			...
			mountComponent: function(t, e, n, o) {
				...
				}(l) ? this._compositeType = g : this._compositeType = v : (a = d, _(), null === d || !1 === d || i.isValidElement(d) || r("105", l.displayName || l.name || "Component"), d = new y(l), this._compositeType = m), d.props = s, d.context = u, d.refs = f, d.updater = p, this._instance = d, c.set(d, this);
				var A, E = d.state;
					...
					for (f in e)
						if (e.hasOwnProperty(f)) {
							var d = (h = t && t[f]) && h._currentElement,
								g = e[f];
							if (null != h && i(d, g)) r.receiveComponent(h, g, s, l), e[f] = h;
							else {
				...
				if (s || r) {
					...
					for (l in s)
						if (s.hasOwnProperty(l)) {
							var v = r && r[l],
								m = s[l];
							v === m ? (p = u(p, this.moveChild(v, g, f, h)), h = Math.max(v._mountIndex, h), v._mountIndex = f) : (v && (h = Math.max(v._mountIndex, h)), p = u(p, this._mountChildAtIndex(m, a[d], g, f, e, n)), d++), f++, g = i.getHostNode(m)
	...
	Q.displayName = "ReactDOMComponent", Q.Mixin = {
		mountComponent: function(t, e, n, r) {
			...
			switch (this._tag) {
				...
				case "video":
					...
					break;
				case "input":
					v.mountWrapper(this, p, e), p = v.getHostProps(this, p), t.getReactMountReady().enqueue(L, this), t.getReactMountReady().enqueue(V, this);
					break;
				case "option":
			...
			if (R(this, p), null != e ? (o = e._namespaceURI, a = e._tag) : n._tag && (o = n._namespaceURI, a = n._tag), (null == o || o === u.svg && "foreignobject" === a) && (o = u.html), o === u.html && ("svg" === this._tag ? o = u.svg : "math" === this._tag && (o = u.mathml)), this._namespaceURI = o, t.useCreateElement) {
				...
				g.precacheNode(this, f), this._flags |= w.hasCachedChildNodes, this._hostParent || l.setAttributeForRoot(f), this._updateDOMProperties(null, p, t);
				var A = s(f);
		...
		updateComponent: function(t, e, n, r) {
			...
			switch (R(this, i), this._updateDOMProperties(o, i, t), this._updateDOMChildren(o, i, t, r), this._tag) {
				case "input":
					v.updateWrapper(this), C.updateValueIfChanged(this);
					break;
				case "textarea":
		...
		unmountComponent: function(t) {
			...
			this.unmountChildren(t), g.uncacheNode(this), p.deleteAllListeners(this), this._rootNodeID = 0, this._domID = 0, this._wrapperState = null
		},
		getPublicInstance: function() {
			return k(this)
		}
	...
	var r = n(41),
		...
		s = {
			...
			extractEvents: function(t, e, n, s) {
				...
				return v.type = "mouseenter", v.target = d, v.relatedTarget = h, r.accumulateEnterLeaveDispatches(g, v, c, l), [g, v]
			}
		};
	t.exports = s
}, function(t, e, n) {
	...
	function k(t) {
		"value" === t.propertyName && A(v, t) && y(t)
	}
	...
	function S(t, e, n) {
		if ("topSelectionChange" === t || "topKeyUp" === t || "topKeyDown" === t) return A(v, n)
	}
	...
	t.exports = {
		inject: function() {
			E || (E = !0, m.EventEmitter.injectReactEventListener(v), m.EventPluginHub.injectEventPluginOrder(a), m.EventPluginUtils.injectComponentTree(p), m.EventPluginUtils.injectTreeTraversal(h), m.EventPluginHub.injectEventPluginsByName({
				SimpleEventPlugin: A,
	...
	t.exports = function(t, e, n) {
					...
					if (n.hasOwnProperty(s) && s !== a) {
						...
						if (l(f, s), c.hasOwnProperty(s)) c[s](t, p);
							...
							if ("function" != typeof p || g || f || !1 === n.autobind)
								if (f) {
									var v = u[s];
									i(g && ("DEFINE_MANY_MERGED" === v || "DEFINE_MANY" === v), "ReactClass: Unexpected spec policy %s for key %s when mixing in component specs.", v, s), "DEFINE_MANY_MERGED" === v ? r[s] = h(r[s], p) : "DEFINE_MANY" === v && (r[s] = d(r[s], p))
								} else r[s] = p;
		...
		return r(_.prototype, t.prototype, y),
			function(t) {
				...
				for (var r in e.prototype = new _, e.prototype.constructor = e, e.prototype.__reactAutoBindPairs = [], s.forEach(p.bind(null, e)), p(e, v), p(e, t), p(e, m), e.getDefaultProps && (e.defaultProps = e.getDefaultProps()), i(e.prototype.render, "createClass(...): Class specification must implement a `render` method."), u) e.prototype[r] || (e.prototype[r] = null);
				return e
			}
	}
}, function(t, e, n) {
	...
	function d(t, e, n) {
		...
		Array.isArray(c) ? g(c, r, n, i.thatReturnsArgument) : null != c && (o.isValidElement(c) && (c = o.cloneAndReplaceKey(c, a + (!c.key || e && e.key === c.key ? "" : l(c.key) + "/") + n)), r.push(c))
	}
	...
	t.exports = function(t, e, n) {
		...
		i[r++] = g >>> 8 & 255, i[r++] = 255 & g, i[r++] = g >>> 24 & 15 | 16, i[r++] = g >>> 16 & 255, i[r++] = l >>> 8 | 128, i[r++] = 255 & l;
	...
	(function(e) {
		for (var r = n(558), o = "undefined" == typeof window ? e : window, i = ["moz", "webkit"], a = "AnimationFrame", s = o["request" + a], u = o["cancel" + a] || o["cancelRequest" + a], c = 0; !s && c < i.length; c++) s = o[i[c] + "Request" + a], u = o[i[c] + "Cancel" + a] || o[i[c] + "CancelRequest" + a];
		if (!s || !u) {
			var l = 0,
				p = 0,
				f = [];
	...
	var v = h.default.createClass({
		...
		clearUnreadPropStyle: function(t) {
			for (var e = g(this.props.willEnter, this.props.willLeave, this.state.mergedPropsStyles, t, this.state.currentStyles, this.state.currentVelocities, this.state.lastIdealStyles, this.state.lastIdealVelocities), n = e[0], o = e[1], i = e[2], a = e[3], s = e[4], u = 0; u < t.length; u++) {
				var c = t[u].style,
					l = !1;
				for (var p in c)
					...
					for (var w in _)
						if (_.hasOwnProperty(w)) {
							...
							if ("number" == typeof x) b[w] = x, A[w] = 0, E[w] = x, C[w] = 0;
								...
								for (var k = v[y][w], T = m[y][w], S = 0; S < a; S++) {
				...
				for (var o = (t.accumulatedTime - Math.floor(t.accumulatedTime / (1e3 / 60)) * (1e3 / 60)) / (1e3 / 60), i = Math.floor(t.accumulatedTime / (1e3 / 60)), a = [], c = [], p = [], f = [], h = 0; h < e.length; h++) {
					...
					for (var _ in d)
						if (d.hasOwnProperty(_)) {
							var b = d[_];
							if ("number" == typeof b) g[_] = b, v[_] = 0, m[_] = b, y[_] = 0;
							else {
								...
								var x = s.default(1e3 / 60 / 1e3, A, E, b.val, b.stiffness, b.damping, b.precision),
									k = x[0],
									T = x[1];
								g[_] = A + (k - A) * o, v[_] = E + (T - E) * o, m[_] = A, y[_] = E
							}
					...
					for (var h in e)
						if (e.hasOwnProperty(h)) {
							...
							if ("number" == typeof d) p[h] = d, f[h] = 0, a[h] = d, c[h] = 0;
								...
								for (var g = t.state.lastIdealStyle[h], v = t.state.lastIdealVelocity[h], m = 0; m < i; m++) {
									var y = s.default(1e3 / 60 / 1e3, g, v, d.val, d.stiffness, d.damping, d.precision);
									g = y[0], v = y[1]
								}
								var _ = s.default(1e3 / 60 / 1e3, g, v, d.val, d.stiffness, d.damping, d.precision),
									b = _[0],
									A = _[1];
								p[h] = g + (b - g) * o, f[h] = v + (A - v) * o, a[h] = g, c[h] = v
							}
						} t.animationID = null, t.accumulatedTime -= i * (1e3 / 60), t.setState({
						currentStyle: p,
						currentVelocity: f,
	...
	class y extends o.Component {
		...
		componentWillReceiveProps(t) {
			...
			if (i.messageId && o.messageId !== i.messageId && (clearTimeout(this.state.previewTimeout), e.previewTimeout = null, e.previewClassroomName = "", Date.now() - i.timeChanged < v)) {
				let t = this.props.classroomSessions.find(t => t.id === i.sessionId);
				t && (e.previewClassroomName = t.classroomName, e.previewTimeout = setTimeout(this._clearPreview, v))
			}
		...
		render() {
			...
			let p = !0;
			s && (p = "left" === s.split("-")[1]);
			let g = !!n.totalUnreadCount && !!this.state.previewTimeout && "message" === n.newestMessage.type,
				v = n.pendingAnnouncements[0],
				m = "";
			if (v) {
				let t = e.find(t => t.id === v.sessionId);
				m = t && t.classroomName
			}
			let y = {},
				_ = {
